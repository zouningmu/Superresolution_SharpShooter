...
%%%%%%%%%%%%%%%%%%%%%%%++++++++++++++++++++++++++
marks = 'D:\Research\2012 fall\20121111 RZ\background\all conc\total all conc.txt'; % position of marks

nanoparticle = 'D:\Research\2012 fall\20121111 RZ\before_correct\all conc\x204y091 all conc.txt';  % file for nanoparticle
outfile = 'D:\Research\2012 fall\20121111 RZ\before_correct\all conc\aftercorrectx204y091.txt';

error_x = 25.5;   % nm  +/-  x direction  error bar
error_y = 25.5;   % nm  +/-  y direction
...
% start correction
[A, B, C, D, sigmax, sigmay, x0, y0, erx, ery, startp, endp]=textread(nanoparticle,'  %f    %f    %f    %f    %f    %f    %f    %f    %f    %f    %f    %f');
erx = abs(erx);
ery = abs(ery);
